...
class OAuthProvidersController extends APIController
{
     ...
     *     operationId="v4_internal_projects_oAuthProvider.index",
     ...
     *         @OA\MediaType(mediaType="application/json", @OA\Schema(ref="#/components/schemas/v4_internal_projects_oAuthProvider.index")),
     *         @OA\MediaType(mediaType="application/xml",  @OA\Schema(ref="#/components/schemas/v4_internal_projects_oAuthProvider.index")),
     *         @OA\MediaType(mediaType="text/csv",      @OA\Schema(ref="#/components/schemas/v4_internal_projects_oAuthProvider.index")),
     *         @OA\MediaType(mediaType="text/x-yaml",      @OA\Schema(ref="#/components/schemas/v4_internal_projects_oAuthProvider.index"))
     *     )
     * )
     *
     * @OA\Schema(
     *   schema="v4_internal_projects_oAuthProvider.index",
     *   type="object",
